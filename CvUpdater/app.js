...
function render() {
    ...
    if (currentView === 'list') {
        ...
        if (currentView === 'detail')
            renderDetail(currentMemberId);
        else if (currentView === 'edit')
            renderEdit(currentMemberId);
    }
...
async function renderDetail(id) {
    ...
    const page = createCvPage(cachedMembers, result, (navigateId) => {
        currentMemberId = navigateId;
        render();
    }, () => { currentView = 'list'; render(); }, () => { currentView = 'edit'; render(); });
...
async function renderEdit(id) {
    ...
    const editor = createCvEditor(member, async (data) => {
